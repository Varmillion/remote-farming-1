...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"app2.js":[function(require,module,exports) {
"use strict";
...
var BASE_URL = 'http://0.0.0.0:5000/api';

var getTodos = function getTodos() {
  return _axios.default.get(BASE_URL + '/user').then(function (response) {
    // handle success
...
var addTodosToDOM = function addTodosToDOM(user) {
